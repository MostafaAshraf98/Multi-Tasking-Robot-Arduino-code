...
const int arrDirs[19] = {0, 2, 2, 2, 2, 2, 0, 2, 2, 3, 1, 1, 1, 1, 1, 1, 1, 0, 1};

// array of length of the lines the robot will paint in meter
const float arrLength[19] = {3, 1, 0.5, 0.5, 0.5, 0.5, 0.5, 1.5, 1, 1.6, 0.5, 1.5, 1, 0.5, 0.5, 0.5, 0.5, 0.5, 1.5};
